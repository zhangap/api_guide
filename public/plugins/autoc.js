(function ( global, factory ) {
    ...
    AutocJS.prototype = {
        ...
        renderSidebarDirectory: function () {
            ...
            // 全部绘制完成，再显示完整的菜单
            //hiliny modify
            this.dom().wrap.removeClass( CLS_HIDE ).addClass(CLS_SHOW);
        ...
        show: function () {
            ...
            $wrap.animate( {
                ...
                //hinly modify
                $wrap.find(".autocjs-hd,.autocjs-bd").css("visibility","visible");
            } );
        ...
        hide: function () {
            ...
            $wrap.animate( {
                ...
                //hinly modify
                $wrap.find(".autocjs-hd,.autocjs-bd").css("visibility","hidden");
            } );
